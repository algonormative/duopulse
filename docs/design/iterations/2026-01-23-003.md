...
commit: 17ed7c4
pr: https://github.com/algonormative/duopulse/pull/26
...
## Target Revision (Applied)

The previous target (0.70-1.00) was **unachievable via rotation alone** without causing regressions.

Revised syncopated zone syncopation target:
- **Old target**: 0.70-1.00
...
2. `tools/evals/evaluate-expressiveness.js` - Revised syncopation target from 0.70-1.00 to 0.55-0.85
